...
#%% Data from camera
x_data,y_data=capture('Rien',10)
X_data.extend(x_data)
Y_data.extend(y_data)
print("Prepare yourself ...")
sleep(2)

x_data,y_data=capture('Play',10)
X_data.extend(x_data)
Y_data.extend(y_data)
print("Prepare yourself ...")
sleep(2)

x_data,y_data=capture('Stop',10)
X_data.extend(x_data)
Y_data.extend(y_data)
print("Prepare yourself ...")
sleep(2)

x_data,y_data=capture('Next',10)
X_data.extend(x_data)
Y_data.extend(y_data)
print("Prepare yourself ...")
sleep(2)

x_data,y_data=capture('Previous',10)
X_data.extend(x_data)
Y_data.extend(y_data)
print("Prepare yourself ...")
sleep(2)
...
#%% CNN training
history=model.fit(x_train, y_train, epochs=5, batch_size=10, verbose=1, validation_data=(x_validate, y_validate))
